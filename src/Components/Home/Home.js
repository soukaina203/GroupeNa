...
"Videos/Home.mp4"
    ...
    <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none * md:text-5xl lg:text-5xl text-white">NexAudit - Redéfinir l'audit pour demain</h1>
        ...
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="dsjn" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white 
            ...
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium 
            text-center text-gray-900 rounded-lg border 

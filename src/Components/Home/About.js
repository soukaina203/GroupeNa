  ...
  return (
    ...
    <>
      ...
      <Zoom>{/*Using Zoom Effect*/}
        ...
        <section className="overflow-hidden pt-20 pb-12 overflow-x-hidden   lg:pt-[120px] 
      lg:pb-[90px]
         dark:bg-dark">
          <div className="container mx-auto p-7 md:p-0 ">
            <div className="flex flex-wrap items-center justify-center -mx-4">
              ...
              <div className="w-full px-4 font-roboto-condensed pl-7 md:pl-0 lg:w-1/2 xl:w-5/12">
                <div className="mt-10 lg:mt-0 lg:ml-4">
                  <span className="block pl-2 mb-4 text-xl font-bold md:pl-0 w-fit underline1 text-[24px] ">
                  À Propos de nous
                  </span>
                  <h2 className="mb-5 pl-2 md:pl-0 text-5xl text-[#003D8A] font-roboto-condensed font-bold text-dark  sm:text-[40px]/[48px]">
                    NexAudit - Redéfinir l'audit pour demain   </h2>
                  <p className="pl-2 mb-5  md:pl-0 text-[20px] text-body-color dark:text-dark-6">
                  ...
                  <p className="pl-2 mb-4 text-[20px] md:pl-0 text-body-color dark:text-dark-6">
                  ...
                  <Link to="contact" smooth={true} offset={-100} duration={500}>
                    ...
                    <a href="#" class="inline-flex justify-center text-xl items-center py-3 px-5  font-medium text-center text-white  rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                      Nous Contacter

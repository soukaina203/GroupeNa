    ...
    return (
        <div className='w-[100%] h-screen  flex justify-center items-center md:items-start '>
            <div className='w-[15rem] h-[15rem]  flex flex-col justify-center  md:justify-start  md:mt-[9rem]  gap-6 '>
                ...
                <h1 className="flex gap-2 py-4  text-6xl font-bold   cursor-pointer md:ml-0 
                flew-row text-[#3218BF] ">
            NexAudit
          </h1>
                </div>

                <div role="status" className='ml-auto mr-auto '>
                    <svg aria-hidden="true" class="inline w-[4rem] h-[4rem] text-gray-200 animate-spin  fill-[#3218BF]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
